function landscape_analysis_from_optimal_5_shells()
    ...
    agent = [1000.0, 2000.0, 3000.0, 4000.0, 20, 15]; % insert optimal
    count = 0; % 1973

    lower = [  600.0, 1600.0, 2600.0, 3600.0, 10,  3];
    upper = [ 1500.0, 2500.0, 3500.0, 5000.0, 20, 15];
    change= [  100.0,  100.0,  100.0,  100.0,  1,  1];

    all_posible_entries_to_use = nchoosek([1,2,3,4,5,6],2);
