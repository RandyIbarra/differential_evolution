function [metric] = objective_function(protocol)
    ...
    protocolname = [int2str(floor(protocol(1) / 100.0)) '_' int2str(floor(protocol(2) / 100.0)) '_' int2str(floor(protocol(3) / 100.0)) '_' int2str(floor(protocol(4) / 100.0)) '_' int2str(floor(protocol(5) / 100.0)) '_' int2str(floor(protocol(6))) 'tau_' int2str(floor(protocol(7))) 'smalldelta' ];
    fprintf('\n\n protocolname : %s \n\n', protocolname);
