function [ans] = test_protocol(protocol)
    Dsoma =  3; 
    Din_UB =  3; 
    Rsoma_UB = 12; 
    De_UB = 3; 
    ...
    [Mdl, train_perf] = setup_and_run_model_training(schemefile, SNR, outputfolder, Dsoma, Din_UB, Rsoma_UB, De_UB, seed_rng, MLmodel, protocolname, figsfolder);

    ans = dot(protocol, protocol);
end
